...
let print_summary label =
  ...
  | ValueExpr e -> prerr_string "Expr_"; prerr_int i; prerr_string " @ "; print_code_loc e.exp_loc
  | ModExpr m -> prerr_string "Mod_"; prerr_int i; prerr_string " @ "; print_code_loc m.mod_loc
